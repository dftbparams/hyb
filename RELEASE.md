# Parameter set hyb-0-2

Density Functional Tight Binding (DFTB) parameter set for organic/inorganic hybrid systems. (For some of the interactions no published tests available!)
